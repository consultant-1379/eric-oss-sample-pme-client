...
*/ -}}
{{- define "eric-oss-sample-pme-client.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-sample-pme-client.mergeAnnotations" -}}
  {{- include "eric-oss-sample-pme-client.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-sample-pme-client.mergeLabels" -}}
  {{- include "eric-oss-sample-pme-client.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
